...
(() => {
  ...
  function g(e = {}, t = {}) {
    Object.keys(t).forEach((s) => {
      void 0 === e[s]
        ? (e[s] = t[s])
        : u(t[s]) && u(e[s]) && Object.keys(t[s]).length > 0 && g(e[s], t[s]);
    });
  }
  const m = {
    body: {},
  ...
  function P(e) {
    ...
    const d = s > l ? "next" : "prev",
      ...
      h = () => {
        ...
        const e = Math.max(Math.min((r - o) / a, 1), 0),
  ...
  const F = {
    ...
    updateSlides: function () {
      ...
      for (let n = 0; n < h; n += 1) {
        ...
        const r = c.eq(n);
        if (
          (T && e.grid.updateSlide(n, r, h, t), "none" !== r.css("display"))
        ) {
      ...
      if (
        ...
        if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!l.support.smoothScroll)
            return (
              P({ swiper: l, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
  ...
  const W = {
    slideTo: function (e, t, s, i, n) {
      ...
      if ((l.animating && o.preventInteractionOnTransition) || (!g && !i && !n))
        return !1;
  ...
  function X(e) {
    ...
    if (a.preventedByNestedSwiper) return (l.startX = c), void (l.startY = h);
    if (!s.allowTouchMove)
      return (
        L(a.target).is(i.focusableElements) || (s.allowClick = !1),
        void (
          i.isTouched &&
    ...
    if (
      ...
      L(a.target).is(i.focusableElements)
    )
  ...
  function U(e) {
    const t = this,
      s = t.touchEventsData,
      { params: i, touches: n, rtlTranslate: l, slidesGrid: r, enabled: o } = t;
    if (!o) return;
    let a = e;
    if (
      (a.originalEvent && (a = a.originalEvent),
  ...
  const ne = {
    setBreakpoint: function () {
      ...
      p && s && e.changeDirection(), $(e.params, a);
    ...
    s({
      ...
      i("click", (e, s) => {
        const { $nextEl: i, $prevEl: l } = t.navigation,
          r = s.target;
        if (t.params.navigation.hideOnClick && !L(r).is(l) && !L(r).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
      ...
      Object.assign(t.navigation, { update: o, init: c, destroy: h });
  }
  function ge(e) {
    return (
      void 0 === e && (e = ""),
      ...
      if (
        ...
        if (s.dynamicBullets) {
          const n = Math.min(i.length, s.dynamicMainBullets + 4),
            l = (r * n - r) / 2 - h * r,
            o = e ? "right" : "left";
          i.css(t.isHorizontal() ? o : "top", `${l}px`);
        }
      }
      if (
        ("fraction" === s.type &&
          (l.find(ge(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          l.find(ge(s.totalClass)).text(s.formatFractionTotal(h))),
        "progressbar" === s.type)
      ) {
        let e;
    ...
    fe(),
      document.querySelector(".reviews__slider") &&
        new he(".reviews__slider", {
          ...
          navigation: {
            nextEl: ".arrow-reviews .arrow-review_next",
            prevEl: ".arrow-reviews .arrow-review_prew",
          },
          on: {},
        });
  });
  ...
  var Ve = function (e, t, s, i) {
      void 0 === s && (s = 0);
      var n = qe(e).attr("data-lg-size") || i;
      if (n) {
        var l = n.split(",");
        if (l[1])
        ...
        [].forEach.call(e, function (e) {
          for (var t = {}, r = 0; r < e.attributes.length; r++) {
            ...
            if (o.specified) {
              var a = Fe(o.name),
                d = "";
              l.indexOf(a) > -1 && (d = a), d && (t[d] = o.value);
            }
          }
          var c = qe(e),
    ...
    et = (function () {
      ...
      return (
        ...
        (e.prototype.openGallery = function (e, t) {
          ...
          if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
            ...
            this.zoomFromOrigin &&
              ...
              (l = je(t, this.outer, o, a, this.currentImageSize))),
        ...
        (e.prototype.getDummyImageContent = function (e, t, s) {
          var i;
          if ((this.settings.dynamic || (i = qe(this.items).eq(t)), i)) {
            var n = void 0;
            if (
        ...
        (e.prototype.triggerSlideItemLoad = function (e, t, s, i, n) {
          ...
          setTimeout(function () {
            e.addClass("lg-complete lg-complete_"),
              l.LGel.trigger(_e, { index: t, delay: s || 0, isFirstSlide: n });
          }, o);
        }),
        ...
        (e.prototype.loadContent = function (e, t) {
          ...
          if (
            ...
            if (m) {
              ...
              w = Ue(l, T || "", g, this.settings.strings.playVideo, u);
              n.prepend(w);
            } else if (u) {
          ...
          v && !qe(document.body).hasClass("lg-from-hash") && (E = v),
            ...
            (this.isFirstSlideWithZoomAnimation() &&
              ...
              this.onLgObjectLoad(n, e, v, E, f, !(!u || !u.html5 || l)),
            (this.zoomFromOrigin && this.currentImageSize) ||
        ...
        (e.prototype.getItemsToBeInsertedToDom = function (e, t, s) {
          ...
          if (e < (this.galleryItems.length - 1) / 2) {
            ...
            for (o = e; o <= this.galleryItems.length - 1 && o < e + l / 2; o++)
              n.push("lg-item-" + this.lgId + "-" + o);
          ...
          "lg-slide" !== this.settings.mode && this.outer.addClass("lg-slide"),
            setTimeout(function () {
              ...
              if (
                ...
                var o = qe(s.target);
                n.isPosterElement(o) && n.LGel.trigger(Me);
              }
        ...
        (e.prototype.enableDrag = function () {
          ...
          this.settings.enableDrag &&
            ...
            qe(window).on("mousemove.lg.global" + this.lgId, function (l) {
              i &&
                e.lgOpened &&
                ((n = !0),
            ...
            qe(window).on("mouseup.lg.global" + this.lgId, function (l) {
              if (e.lgOpened) {
                var r = qe(l.target);
                n
        ...
        (e.prototype.closeGallery = function (e) {
          ...
          this.LGel.trigger(De), qe(window).scrollTop(this.prevScrollTop);
          var s,
  ...
  st.length &&
    ...
    (window.onload = function () {
      function e(e, t, s = !0) {
        const i = document.querySelector(".header__shop"),
          n = i.querySelector(".header__icon-shop"),
          l = n.querySelector("span"),
          r = document.querySelector(`[data-card-pid="${t}"]`),
          o = document.querySelector(".list-card"),
          a = i.querySelector(".card__number"),
          d = a.querySelector("span"),
          c = document.querySelector(".order__number"),
          h = c.querySelector("span");
        if (s) {
          if (
            (l
            ...
            d
              ...
              : a.insertAdjacentHTML("beforeend", "<span>1</span>"),
            h
              ? (h.innerHTML = ++h.innerHTML)
              : c.insertAdjacentHTML("beforeend", "<span>1</span>"),
            r)
          ) {
            const e = r.querySelector(".list-card__price span");
            e.innerHTML = ++e.innerHTML;
          } else {
            const e = document.querySelector(`[data-pid="${t}"]`),
              s = `\n                                    <a href="" class="list-card__image">${
                e.querySelector(".item-catalog__image-ibg").innerHTML
              }</a>\n                                    <div class="list-card__text">\n                                        <div class="list-card__body">\n                                            <div class="list-card__title">${
                e.querySelector(".item-catalog__title").innerHTML
              }</div>\n                                            <a href="" class="list-card__link _icon-trash"></a>\n                                        </div>\n                                        <div class="list-card__price"> quantity: <span>1</span> price: ${
                e.querySelector(".item-catalog__price").innerHTML
              }</div>\n                                    </div>`;
            o.insertAdjacentHTML(
              "beforeend",
              `<li data-card-pid="${t}" class="list-card__item">${s}</li>`
            );
          }
          e.classList.remove("_hold");
        } else {
          const e = r.querySelector(".list-card__price span"),
            t = i.querySelector(".card__number span"),
            s = document.querySelector(".order__number span");
          (e.innerHTML = --e.innerHTML),
            (t.innerHTML = --t.innerHTML),
            (s.innerHTML = --s.innerHTML),
            parseInt(e.innerHTML) || r.remove();
          const n = --l.innerHTML;
          n ? (l.innerHTML = n) : (l.remove(), i.classList.remove("_active"));
        }
      }
      document.addEventListener("click", function (t) {
        const s = t.target;
        if (s.classList.contains("item-catalog__btn")) {
          const i = s.closest(".item-catalog").dataset.pid;
          !(function (t, s) {
            if (!t.classList.contains("_hold")) {
              t.classList.add("_hold"), t.classList.add("_fly");
              const i = document.querySelector(".header__icon-shop"),
                n = document
                  .querySelector(`[data-pid="${s}"]`)
                  .querySelector(".item-catalog__image-ibg"),
                l = n.cloneNode(!0),
                r = n.offsetWidth,
                o = n.offsetHeight,
                a = n.getBoundingClientRect().top,
                d = n.getBoundingClientRect().left;
              l.setAttribute("class", "_flyImage _ibg"),
                (l.style.cssText = `\n            left: ${d}px;\n            top: ${a}px;\n            width: ${r}px;\n            height: ${o}px;\n            `),
                document.body.append(l);
              const c = i.getBoundingClientRect().left,
                h = i.getBoundingClientRect().top,
                p = i.offsetWidth,
                u = i.offsetHeight;
              (l.style.cssText = `\n            left: ${c}px;\n            top: ${h}px;\n            width: ${p}px;\n            height: ${u}px;\n            transform: scale(0);\n            opacity: 0;\n            `),
                l.addEventListener("transitionend", function () {
                  t.classList.contains("_fly") &&
                    (l.remove(), e(t, s), t.classList.remove("_fly"));
                });
            }
          })(s, i),
            t.preventDefault();
        }
        s.classList.contains("header__icon-shop") ||
        s.closest(".header__icon-shop")
          ? (document.querySelector(".list-card").children.length > 0 &&
              document
                .querySelector(".header__card")
                .classList.toggle("_active"),
            t.preventDefault())
          : s.closest(".header__card") ||
            s.classList.contains("item-catalog__btn") ||
            document.querySelector(".header__card").classList.remove("_active");
        s.classList.contains("card__btn") &&
          document.querySelector(".header__card").classList.remove("_active");
        s.classList.contains("header__button") &&
          document.querySelector(".header__card").classList.remove("_active");
        if (s.classList.contains("list-card__link")) {
          const i = s.closest(".list-card__item").dataset.cardPid;
          e(s, i, !1), t.preventDefault();
        }
      });
    }),
    (window.FLS = !0),
    ...
    (function () {
      ...
      e &&
        e.addEventListener("click", function (e) {
          n && (l(), document.documentElement.classList.toggle("menu-open"));
        });
    })(),
    (function () {
        ...
        function o(e) {
          ...
          if (t.closest("[data-spoller]")) {
            ...
            n.querySelectorAll("._slide").length ||
              (l && !s.classList.contains("_spoller-active") && a(n),
    ...
    (function () {
      ...
      function n(e, t) {
        e.forEach((e) => {
          ...
          e.querySelectorAll("[data-tabs-item]").forEach((l, r) => {
            t.matches
    ...
    (function () {
      ...
      function o(e, t) {
        ...
        if ("items" === (e.dataset.showmore ? e.dataset.showmore : "size")) {
          ...
          s = t.dataset.showmoreContent ? t.dataset.showmoreContent : 1;
        }
        return s;
      }
      function a(e) {
